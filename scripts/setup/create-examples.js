...
async function createExampleProjects() {
  ...
  await fs.writeJSON(path.join(fullstackPath, 'config.json'), fullstackConfig, { spaces: 2 });
  ...
  console.log('   4. fullstack-legacy (Node.js 16) - ports 3000, 5432 [CUSTOM IMAGE]');
  ...
  console.log('   Tool: run_command, Args: {"project_name": "web-app", "command": "python3 --version"}');
  console.log('   Tool: run_command, Args: {"project_name": "web-app", "command": "which rg"}');
}
