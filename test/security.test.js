...
describe('SecurityManager', () => {
  ...
  test('should validate safe commands with project config', () => {
    ...
    safeCommands.forEach(cmd => {
      assert.doesNotThrow(() => securityManager.validateCommand(cmd, projectConfig));
    });
  });
  ...
  test('should block dangerous commands in restricted mode', () => {
    ...
    dangerousCommands.forEach(cmd => {
      assert.throws(() => securityManager.validateCommand(cmd, projectConfig), 
  ...
  test('should require project config', () => {
    assert.throws(() => securityManager.validateCommand('ls'), 
      /Invalid project configuration/);
    assert.throws(() => securityManager.validateCommand('ls', null), 
      /Invalid project configuration/);
  });
  ...
  test('should validate command structure and format', () => {
    ...
    assert.throws(() => securityManager.validateCommand('', projectConfig), 
    ...
    assert.doesNotThrow(() => securityManager.validateCommand('echo hello', projectConfig));
  });
});
